...
#[Route('/years')]
final class YearsController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('years/new.html.twig', [
            'year' => $year,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Years $year, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('years/edit.html.twig', [
            'year' => $year,
            'form' => $form,
        ]);
    }
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$year->getId(), $request->getPayload()->getString('_token'))) {
